...
import { Send, Mail, Phone, MapPin, Github, Linkedin, CheckCircle, AlertCircle, Loader2, Sparkles, Heart } from "lucide-react";
    ...
    <section className="py-4 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(145deg, rgba(244,114,182,0.08), rgba(139,92,246,0.08), rgba(6,182,212,0.08))",
            border: "1px solid rgba(255,255,255,0.8)",
          }}
        >
          {/* Background glow - dark mode only */}
          <div className="absolute top-0 right-0 w-40 h-40 rounded-full blur-3xl opacity-20 dark:opacity-30"
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/10 transition-all duration-300 group"
              >
                <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-rose-500 to-pink-500">
                  <Mail className="w-5 h-5 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Email</p>
                  <p className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-rose-500 dark:group-hover:text-rose-400 transition-colors truncate">
                    chaitanyaumbarkar2002@gmail.com
                  </p>
                </div>
              </a>

              <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10">
            ...
            <div className="space-y-3">
              <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Connect with me</p>
              <div className="flex items-center gap-3">
                <Link
                  href="https://github.com/ChaitanyaU17"
                  target="_blank"
                  className="w-11 h-11 rounded-xl flex items-center justify-center bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/10 transition-all duration-300 hover:scale-105"
                >
                ...
                <Link
                  ...
                  className="w-11 h-11 rounded-xl flex items-center justify-center bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/10 transition-all duration-300 hover:scale-105"
                >
                  <FaSquareXTwitter className="w-5 h-5 text-gray-700 dark:text-gray-300" />
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center text-gray-400 group-focus-within:text-indigo-500 transition-colors">
